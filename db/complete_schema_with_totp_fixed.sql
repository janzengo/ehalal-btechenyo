-- Complete E-Halal Database Schema with TOTP Support (Fixed)
-- This file includes the original schema (fixed) plus TOTP tables with proper constraint handling
...
INSERT INTO `admin` (`id`, `username`, `email`, `password`, `firstname`, `lastname`, `photo`, `created_on`, `role`, `gender`, `totp_enabled`) VALUES
(1, 'head', 'ehalal.btechenyo@gmail.com', '$2y$10$jXYXPnAatj7SHgBn2JfNDOHl3.x6mCYncHbCnzzXoXpd8sq.bWBsy', 'Electoral', 'Head', '', '2024-06-06', 'head', 'Male', 0);
...
--
-- Table structure for table `admin_totp_secrets`
--
...
--
-- Table structure for table `admin_backup_codes`
--
...
--
-- Table structure for table `admin_totp_attempts`
--
...
CREATE TABLE `election_history` (
  ...
  KEY `idx_election_history_control` (`control_number`),
  KEY `idx_status_history` (`status`,`end_time`),
  KEY `idx_election_end_status` (`end_time`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `otp_requests` (
  ...
  `expires_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_student_otp` (`student_number`,`otp`),
...
--
-- Constraints for table `admin_totp_secrets`
--
ALTER TABLE `admin_totp_secrets`
  ADD CONSTRAINT `fk_admin_totp_secrets_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `admin_backup_codes`
--
ALTER TABLE `admin_backup_codes`
  ADD CONSTRAINT `fk_admin_backup_codes_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `admin_totp_attempts`
--
ALTER TABLE `admin_totp_attempts`
  ADD CONSTRAINT `fk_admin_totp_attempts_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE CASCADE;
