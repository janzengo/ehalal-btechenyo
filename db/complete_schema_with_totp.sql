-- Complete E-Halal Database Schema with TOTP Support
-- This file includes the original schema (fixed) plus TOTP tables
...
--
-- Ensure admin table has proper primary key before creating TOTP tables
--
